"""Tests for structured-output agents (Research Manager and Sentiment Analyst).

The Portfolio Manager has its own coverage in tests/test_memory_log.py
(which exercises the full memory-log → PM injection cycle).  This file
covers the parallel schemas, render functions, and graceful-fallback
behavior for the Research Manager and Sentiment Analyst
...
class TestSentimentAnalystAgent:
    ...
    def test_falls_back_to_freetext_when_structured_unavailable(self):
        ...
        assert plain in create_sentiment_analyst(llm)(_make_sentiment_state())["sentiment_report"]
